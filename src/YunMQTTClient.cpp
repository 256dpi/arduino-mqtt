...
boolean YunMQTTClient::updateBridge() {
  ...
  int r2 = p.runShellCommand("wget -N https://raw.githubusercontent.com/256dpi/arduino-mqtt/v1.8.2/yun/mqtt.py --no-check-certificate -P /usr/arduino-mqtt");
  int r3 = p.runShellCommand("wget -N https://raw.githubusercontent.com/256dpi/arduino-mqtt/v1.8.2/yun/bridge.py --no-check-certificate -P /usr/arduino-mqtt");
